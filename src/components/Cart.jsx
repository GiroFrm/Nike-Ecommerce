...
import { selectCartItems, selectCartState, setClearCartITems,setCloseCart, 
    setGetTotals, 
    selectTotalAmount, 
    selectTotalQTY } from '../app/CartSlice.js';
...
const Cart = () => {
  ...
  return (
    <>
     ...
     opacity-100 z-[250]${ifCartState ? 'opacity-100 visible translate-x-0': 'opacity-0 invisible translate-x-8'}`}>
